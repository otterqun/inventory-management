  ...
  <div class="min-h-screen bg-slate-100 p-4 md:p-8 font-sans relative">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
      ...
      <!-- GRID BAWAH (Carta & Sejarah) -->
        ...
        <!-- 4. Kotak Placeholder Sejarah -->
        <div class="bg-white p-6 rounded-2xl shadow-sm border-t-4 border-amber-500 h-[350px]">
            <h3 class="text-lg font-bold text-gray-700 mb-4">Sejarah Aktiviti</h3>
            <p class="text-gray-400 flex items-center justify-center h-full">Log sejarah akan datang...</p>
        </div>

      </div> <!-- Tutup Grid Bawah -->
